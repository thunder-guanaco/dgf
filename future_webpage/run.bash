...
# CHECK ARGUMENTS
if [[ ! "$1" =~ (test|makemigrations|runserver|shell|makemessages) ]]
then
  echo -e "\n  Usage: $0 <test, makemigrations, runserver, shell, makemessages>\n"
  exit 1
fi
...
case "$1" in
  ...
  test)
    ...
    ;;
  makemigrations|runserver|shell|makemessages)
