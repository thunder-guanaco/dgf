...
class FriendModelTest(TestCase):
    ...
    def test_first_and_last_name(self):
        self.assert_field('first_and_last_name', expected='Manuel García García',
                          username='manolo', first_name='Manuel', last_name='García García', nickname='Manolo')
        self.assert_field('first_and_last_name', expected='David Strott',
                          username='david', first_name='David', last_name='Strott', nickname=None)
        self.assert_field('first_and_last_name', expected='Markus',
                          username='markus', first_name='Markus', last_name='', nickname='Mendoza')
        self.assert_field('first_and_last_name', expected='David',
                          username='davidb', first_name='David', last_name='', nickname=None)
